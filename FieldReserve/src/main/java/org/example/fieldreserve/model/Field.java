...
public class Field {
    ...
    private Long fieldID; //Every Field will be identified with a unique ID --> will be generated by database
    ...
    public Field(String fieldName, String fieldLocation, double hourlyRate, boolean availabilityStatus){
    ...
    //Getters and Setters
    public Long getFieldID() {return fieldID;} //we only need getter for this, removed the setter
